...
Both `quality` and `poor_query_percentage` should be **rounded to 2 decimal places**. Both metrics should be **NULL** if there are no queries for the `query_name`.
