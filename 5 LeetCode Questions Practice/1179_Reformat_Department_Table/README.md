...
**Explanation:** The revenue from Apr to Dec is null. Note that the result table has 13 columns (1 for the `id` and 12 for the months).

---

**Runtime :** 518 ms | **Beats :** 77.53%